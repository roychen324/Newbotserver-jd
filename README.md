<p align="center">
  <img src="https://telegra.ph/file/1f52cd8cf6a8107ee30ea.jpg" alt="JD-The-File-Donor Logo">
</p>
<h1 align="center">
  <b>JD-The-File-Donor Bot</b>
</h1>

![Typing SVG](https://readme-typing-svg.herokuapp.com/?lines=Welcome+To+JD-The-File-Donor!;Created+by+Jᴏᴇʟ+ᠰ+TɢX!;A+simple+and+powerful+Bot!;Indexes+Files+above+2GB;A+Bot+with+double+button!;Start+message+with+pic!;And+more+features!)
</p>
...
[![Deploy to Koyeb](https://www.koyeb.com/static/images/deploy/button.svg)](https://app.koyeb.com/deploy?type=git&repository=github.com/Localusersbot/Newbotserver-jd&env[BOT_TOKEN]&env[API_ID]&env[API_HASH]&env[CHANNELS]&env[ADMINS]&env[PICS]&env[LOG_CHANNEL]&env[AUTH_CHANNEL]&env[CUSTOM_FILE_CAPTION]&env[DATABASE_URI]&env[DATABASE_NAME]=moviesfiles&env[COLLECTION_NAME]=Telegram_files&run_command=python%20bot.py&branch=master&name=jd-file-sharer)
<details><summary>Deploy To Heroku</summary>
<p>
<br>
<a href="https://heroku.com/deploy?template=https://github.com/Localusersbot/Newbotserver-jd">
